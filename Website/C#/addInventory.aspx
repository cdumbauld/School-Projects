...
<%	
	...
	//checks to see if textboxes contain information. if text box is empty will send an error message.
	...
	else
	{
		...
		// inserts values submitted by the user into the inventory table of the database
